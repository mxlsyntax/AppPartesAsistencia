        ...
        <table id="tablaMaquinas" class="table table-striped"
            ...
            <thead>
                <tr>
                    ...
                    <th data-field="mqcdp" data-sortable="true">Código</th>
                    <th data-field="maq_es" data-sortable="true">Estado</th>
                    <th data-field="mq_gar" data-sortable="true">Fecha Garantía</th>
                    <th data-field="mq_prv" data-sortable="true">Referencia</th>
                    <th data-field="maq_vdo" data-sortable="true">Vendedor</th>
                    <th data-field="maq_man" data-visible="false" data-sortable="true">Mantenimiento</th>
                    <th data-field="mq_ccl" data-sortable="true">Denominación Cliente</th>
                </tr>
            </thead>
        </table>
    </div>
