...
<html lang="es">
    <head>
        ...
        <script>
            ...
            function EscribirHistorico(){
                ...
                $.ajax({
                    url: url_conexion,
                    data: {"servidor_ip_publica": servidor_ip_publica, "puerto": puerto, "empresa_gestora": empresa_gestora, "aplicacion": aplicacion, "ejercicio": ejercicio, "empresa_id": empresa_id, "ventana_pref": ventana_pref, "arg": arg, "accion": accion, "accion_gsb": accion_gsb, "cd_pref_autogen": cd_pref_autogen, "respuesta": respuesta},
                    type: "POST",
    ...
    <body id="page-top" onload="ComprobarConfiguracion()">  <div class="g-signin2" data-onsuccess="onSignIn"></div>  
        <!-- APP BAR-->
            ...
            <div class="container-fluid"  style="max-width: 600px;">                
                ...
                <div class="row text-center" style="margin-top:10px;">
                    <div class="col">
                        ...
                        <button class="btn btn-global" type="button" onclick="location.href='viajes_bus.php'" style="margin: 10px; min-height: 70px; min-width: 170px;">Viajes</button>
                        <button class="btn btn-global" type="button" onclick="location.href='dietas_bus.php'" style="margin: 10px; min-height: 70px; min-width: 170px;">Dietas</button>
