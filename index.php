    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function comprobar_uuid(){
                ...
                $.ajax({
                    url: url_conexion_bd,
                    data: {"uuid": uuid, "accion": "comprobar_uid"},
                    type: "POST",
            ...
            function AbrirModalCodigoPref(obligatorio){
                ...
                if (obligatorio){
                    ...
                    $('#modalCodigoPref').modal({backdrop: 'static'});
                    //no funciona lo de escape
                    $('#modalCodigoPref').modal({keyboard: 'true'});
                } else {
                    $('#modalCodigoPref').modal({backdrop: true});
                }
            ...
            function escribir_autogen_uuid(){
                ...
                $.ajax({
                    url: url_conexion_bd,
                    data: {"uuid": uuid, "accion": "comprobar_cdautogen", "cd_pref_autogen": cd_pref_autogen, "nav_y_disp": nav_y_disp},
                    type: "POST",
                    //NG20240702 ESTABLECEMOS EL TIEMPO MAXIMO, PORQUE SI NO ES MUY LARGA Y PARECE QUE NO HA HECHO NADA
                    timeout: 2000,
                    success: function (response) {
            ...
            function obtener_pref_autogen(cd_pref_devuelto){
                ...
                $.ajax({
                    url: url_conexion_bd,
                    data: {"accion": "pref_autogen", "cd_pref_autogen": cd_pref_autogen},
                    type: "POST",
                    //NG20240702 ESTABLECEMOS EL TIEMPO MAXIMO, PORQUE SI NO ES MUY LARGA Y PARECE QUE NO HA HECHO NADA
                    timeout: 2000,
                    success: function (response) {
            ...
            function passPref(){
                ...
                if (opcion != null){                
                    if(opcion == 'global'){
                        //NG20240618 ABRIMOS EL MODAL DESDE JAVASCRIPT.
                        $('#modalPreferences').modal({backdrop: 'static'}) 
                                    ...
                                    if (respuesta['resultado'] == "ok"){
                                        ...
                                        if (respuesta['licencia'] == GetVariableLocalStorage("id_licencia_gsb_pref")){
                                            ...
                                            if (crear_pass == 1){
                                                ...
                                                $('#modalCrearPass').modal({backdrop: 'static'});
                ...
                if(!reg.test(password_crea_pass1)){
                    ...
                    if ((servidor_ip_publica == "")|(puerto == "")|(empresa_gestora == "")|(aplicacion == "")|(ejercicio == "")|(empresa_id == "")|(ventana_pref == "")){
                        ...
                        $.ajax({
                            ...
                            //con esta url si llega a conectar con el php pero no llega a gsbase                    
                            //url: 'https://www.globalsystem.es/AppWeb/AppViajesDietas/funciones.php',
                            data: {"servidor_ip_publica": servidor_ip_publica, "puerto": puerto, "empresa_gestora": empresa_gestora, "aplicacion": aplicacion, "ejercicio": ejercicio, "empresa_id": empresa_id, "ventana_pref": ventana_pref, "arg": arg, "accion": accion, "accion_gsb": accion_gsb },
                            type: "POST",
                            //NG20240702 ESTABLECEMOS EL TIEMPO MAXIMO, PORQUE SI NO ES MUY LARGA Y PARECE QUE NO HA HECHO NADA
                            timeout: 2000,
                            success: function (response) {
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <div class="modal-header border-0">
                            <button class="btn-close" type="button" data-bs-dismiss="modal" aria-label="Close" onclick="CerrarModalPref()"></button></div>
                    </div>
